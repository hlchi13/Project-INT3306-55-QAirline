            ...
            <div className="content">
                    <div className="footer__row">
                            <section className="footer__column">
                                <h3 className="footer__heading">QAirline</h3>
                                <ul className="footer__list">
                                    <li>
                                        <a href="#!" className="footer__link">
                                            Giới thiệu về QAirline
                                        </a>
                                    </li>
                            ...
                            <section className="footer__column">
                                <h3 className="footer__heading">Pháp lý</h3>
                                <ul className="footer__list">
                                    <li>
                                        <a href="#!" className="footer__link">
                                        Bảo mật thông tin
                            ...
                            <section className="footer__column">
                                <h3 className="footer__heading">Thông tin hữu ích</h3>
                                <ul className="footer__list">
                                    <li>
                                        <a href="#!" className="footer__link">
                                            Hướng dẫn đặt vé
                            ...
                            <section className="footer__column">
                                <h3 className="footer__heading">Hỗ trợ</h3>
                                <ul className="footer__list">
                                    <li>
                                        <a href="#!" className="footer__link">
                                            Câu hỏi thường gặp
                    ...
                    <div className="footer__item">
                        ...
                        <div className="footer__item">
                            <h3 className="footer__heading">Hotline hỗ trợ: 1900.0202</h3>
                            <h3 className="footer__heading mt-10" >Email: help@qairline.com</h3> 
                        </div>
                        <div className="footer__item">
                            <h3 className="footer__heading">CÔNG TY CỔ PHẦN HÀNG KHÔNG QAIRLINE</h3>
                            <p className="footer__text mt-10" >Địa chỉ: Số xxx Xuân Thuỷ, Quận Cầu Giấy, TP. Hà Nội, Việt Nam</p>
                            <p className="footer__text mt-10">Điện thoại: 024.1234.5678</p>
                        </div>
                    </div>
